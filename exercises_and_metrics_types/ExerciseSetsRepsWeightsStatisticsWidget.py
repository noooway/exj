...
class ExerciseSetsRepsWeightsStatisticsWidget( GridLayout ):
    def __init__( self, exercise_sets_reps_weights_name,
                  journal, **kwargs ):
        super( ExerciseSetsRepsWeightsStatisticsWidget,
               self ).__init__( **kwargs )
        self.cols = 1
        self.spacing = 1
        self.exercise_name = exercise_sets_reps_weights_name
        excercise_label = Label(
            text = "(ExerciseSetsRepsWeights, default plot type)",
            size_hint_y = 0.1 )
    ...
    def update_drawing(self, *args):
        ...
        ExerciseSetsRepsWeightsStatisticsWidget.gen_drawing_instructions(
